...
export function FeaturesReseau() {
  return (
    <section id="reseau" className="scroll-mt-20 bg-white py-20">
      <div className="mx-auto grid max-w-6xl items-start gap-12 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        <div>
          <ReseauSearchMockup />
        </div>
        <div>
          <span className="inline-flex rounded-lg bg-emerald-50 px-3 py-1 text-xs font-semibold uppercase tracking-wide text-emerald-800">
          ...
          <div className="mt-10 grid grid-cols-3 gap-4 border-t border-gray-100 pt-8">
            <div>
              <p className="text-3xl font-bold tabular-nums text-gray-900 md:text-4xl">247</p>
              <p className="mt-1 text-[13px] text-gray-500">véhicules disponibles</p>
            </div>
            <div>
              <p className="text-3xl font-bold tabular-nums text-gray-900 md:text-4xl">38</p>
              <p className="mt-1 text-[13px] text-gray-500">marchands actifs</p>
            </div>
            <div>
              <p className="text-3xl font-bold tabular-nums text-gray-900 md:text-4xl">&lt;24h</p>
